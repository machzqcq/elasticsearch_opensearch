...
# Default Ollama URL can be overridden by setting OLLAMA_URL env var.
# For example: export OLLAMA_URL="http://localhost:11434"
...
def main():
    ...
    try:
        ...
        # pick the first model for demo (or you can prompt the user)
    ...
    model_body = {
        ...
        "description": f"Ollama {selected_model} embedding model",

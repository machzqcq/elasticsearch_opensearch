...
until curl -k -s https://opensearch-node1:9200 -u admin:Developer@123 > /dev/null; do
...
MODEL_GROUP_ID=$(curl -k -s -X POST "https://opensearch-node1:9200/_plugins/_ml/model_groups/_register" -H 'Content-Type: application/json' -u admin:Developer@123 -d'
{
  "name": "my_model_group",
...
curl -k -X PUT "https://opensearch-node1:9200/_ingest/pipeline/my_embedding_pipeline" -H 'Content-Type: application/json' -u "admin:Developer@123" -d'{
...
curl -k -X PUT "https://opensearch-node1:9200/my_index" -H 'Content-Type: application/json' -u "admin:Developer@123" -d'{
  "settings": {
    "index.knn": true,
...
curl -k -X POST "https://opensearch-node1:9200/my_index/_doc" -H 'Content-Type: application/json' -u "admin:Developer@123" -d'{
